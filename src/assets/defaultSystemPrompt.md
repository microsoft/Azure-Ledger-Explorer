...
- `transactions`: Contains parsed transactions (id, file_id, version, flags, size, entry_type, tx_version, tx_view, max_conflict_version, tx_digest, transaction_id, created_at)
